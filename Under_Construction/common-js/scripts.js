	...
	if(isExists('#normal-countdown')){
		...
		$('#normal-countdown').countdown(date, function(event) {
			var $this = $(this).html(event.strftime(''
				+ '<div class="time-sec"><h3 class="main-time">64</h3> <span>Dias</span></div>'
				+ '<div class="time-sec"><h3 class="main-time">23</h3> <span>Horas</span></div>'
				+ '<div class="time-sec"><h3 class="main-time">16</h3> <span>Minutos</span></div>'
				+ '<div class="time-sec"><h3 class="main-time">56</h3> <span>Segundos</span></div>'));
